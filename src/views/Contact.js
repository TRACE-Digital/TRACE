      ...
      <div className="content">
        ...
        <div className="toggle-container">
          <ButtonGroup className="btn-group-toggle" data-toggle="buttons">
            ...
            >
              <span className="d-none d-sm-block d-md-block d-lg-block d-xl-block">Website Support</span>
            ...
            >
              <span className="d-none d-sm-block d-md-block d-lg-block d-xl-block">Feature Request</span>
              <span className="d-block d-sm-none">
            ...
            >
              <span className="d-none d-sm-block d-md-block d-lg-block d-xl-block">Bug Report</span>
              <span className="d-block d-sm-none">
        ...
        <div className="request-form-container">
          {showRequestWebsite ? <RequestWebsiteForm text="Website request form" /> : null}
        </div>

        <div className="request-form-container">
          {showRequestFeature ? <RequestFeatureForm text="Feature request form" /> : null}
        </div>

        <div className="request-form-container">{showBugReport ? <BugReportForm text="Bug report form" /> : null}</div>
      </div>
    </>
  );
}
