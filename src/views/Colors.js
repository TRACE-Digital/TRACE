          ...
          <div className="toggle-containers" style={showSiteFeature ? { padding: '5px' } : null}>
            <ButtonGroup className="btn-group-toggle" data-toggle="buttons">
              <Button
                ...
                onClick={handleSite}
              >
                <span className="d-none d-sm-block d-md-block d-lg-block d-xl-block">Edit Sites</span>
              </Button>
              <Button
                color="info"
                id="1"
              ...
              >
                <span className="d-none d-sm-block d-md-block d-lg-block d-xl-block">Edit Themes</span>
              </Button>
            </ButtonGroup>
                  ...
                  <tr className="siteTr">
                    <td className="siteTd">
                      ...
                      <div className="site-info">
                        {item.site.name}: <span className="userName">{item.userName}</span>
                      </div>
                    </td>
                  </tr>
                ))}
