  ...
  return (
    <div className="site-popup">
      ...
      <Form>
        ...
        <FormGroup>
          <Label for="siteUrl">Account URL</Label>
          <span className="asterisk">*</span>
          <Input
            type="text"
            name="url"
            id="input"
            placeholder="eg. www.instagram.com/coraychan"
        ...
        <Row>
          {tags.map(tag => (
            <Col lg="3" xs="3" key={tag}>
              <input type="checkbox" value={tag} onClick={handleClickCheckbox} defaultChecked={false} />
      ...
      <div className="add-button-container">
        <Button onClick={handleSubmit}>Add to Dashboard</Button>
