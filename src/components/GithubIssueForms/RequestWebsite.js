  ...
  return (
    <div className="issue-forms">
      ...
      <p className="description">
        Use this form to request support for a website in the automated search. Please make sure the site you are
        requesting has a public profile page. We cannot find private accounts like emails or uber.
      </p>
      <Form>
        <Row form>
          <Col md={12}>
